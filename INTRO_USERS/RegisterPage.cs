...
namespace INTRO_USERS
{
    ...
    public partial class RegisterPage : Form
    {
        ...
        private void buttonRegister_Click(object sender, EventArgs e)
        {
            ...
            string username = "", password = "", firstname = "", lastname = "", DoB = "", address1 = "", 
            ...
            try
            {
               SQL.executeQuery("insert into manager values('" + username + "','" + password + "', '" + 
                   firstname+"','" +lastname+ "', '"+DoB+"', null, '"+phone+"', '"+ address1 +"', '"+address2+"', '"+address3+"')");
                Console.WriteLine("insert into manager values('" + username + "','" + password + "', '" +
                   firstname + "','" + lastname + "', '" + DoB + "', '" + null + "', '" + phone + "', '" + address1 + "', '" + address2 + "', '" + address3 + "')");
            }
            catch (Exception ex)
            {
